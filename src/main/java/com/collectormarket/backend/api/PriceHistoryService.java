...
/**
 * Price history (§8.2). Assembles the two independent series - {@code sales} (transactions) and
 * {@code floorHistory} (ASK/floor) - which are kept strictly separate (F-07), plus event bands and,
 * only when both series are empty, related-card suggestions (F-11).
 * <p>
